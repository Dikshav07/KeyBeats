...
export const metadata: Metadata = {
  title: {
    default:
      "KeyBeats — Free Typing Test with Mechanical Keyboard Sounds | WPM & Accuracy",
    template: "%s | KeyBeats",
  },
    ...
    images: [
      {
        ...
        width: 1500,
        height: 1016,
        alt: "KeyBeats — typing test with mechanical keyboard sounds, on-screen keyboard, and real-time WPM tracking",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "KeyBeats — Typing Test with Mechanical Keyboard Sounds",
    description:
